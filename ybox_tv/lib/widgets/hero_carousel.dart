...
class _HeroCarouselState extends State<HeroCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    // Responsive: phones get a compact featured panel, tablets/desktop get a
    // full Netflix-style banner.
    final w = MediaQuery.sizeOf(context).width;
    final heroHeight = w >= 1100
        ? 340.0
        : w >= 700
            ? 280.0
            : 200.0;
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            // My-List heart, top-right over the artwork.
                            Positioned(
                              top: 8,
                              right: 8,
                              child: FavoriteButton(
                                  channel: item, size: 26),
                            ),
                            // Scrim
                            const DecoratedBox(
                              decoration: BoxDecoration(
